...
<nav x-data="{ open: false }" class="font-inter bg-nav text-50 font-bold text-xl static w-screen">
    
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto py-4 lg:py-6 px-4 sm:px-6 lg:p-8">
        <div class="flex justify-center h-12 sm:h-16">
        <div class="font-inter text-white font-bold text-xl static">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 text-xl leading-4 hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div class="hidden sm:text-50">{{ Auth::user()->name }}</div>
