...
<body class="antialiased">
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            ...
            <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><i class="fa-solid fa-user rounded-lg py-2 px-2 border-solid border-4 border-sky-600 "></i></a>
            @endif
            @endauth
        </div>
        @endif
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <nav class="font-inter bg-sky-700 text-white font-bold text-xl static">
